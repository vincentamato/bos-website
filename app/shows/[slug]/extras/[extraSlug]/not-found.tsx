...
export default function ExtraNotFound() {
  return (
    <div className="min-h-screen bg-[#050A14] text-white flex items-center justify-center">
      <div className="container mx-auto px-4 py-16 text-center">
        <h1 className="text-3xl font-bold mb-4">Extra Not Found</h1>
        <p className="text-xl text-gray-400 mb-8">
          The extra content you are looking for doesn't exist or has been removed.
        </p>
        <Link 
          href="/" 
